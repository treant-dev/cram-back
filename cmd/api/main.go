...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/collections/{collectionID}/draft/diff", cardsHandler.GetDraftDiff)
		r.Post("/collections/{collectionID}/draft/items", cardsHandler.AddDraftItem)
		r.Put("/collections/{collectionID}/draft/items/{itemID}", cardsHandler.UpdateDraftItem)
		r.Delete("/collections/{collectionID}/draft/items/{itemID}", cardsHandler.DeleteDraftItem)
		r.Post("/collections/{collectionID}/draft/items/{itemID}/revert", cardsHandler.RevertDraftItem)
		r.Post("/collections/{collectionID}/draft/items/{itemID}/move", cardsHandler.MoveDraftItem)
		...
		r.Post("/collections/{collectionID}/exercises/import", cardsHandler.ImportExercises)
		r.Post("/collections/{collectionID}/import", cardsHandler.ImportItems)
		...
		r.Delete("/collections/{collectionID}/cards/{cardID}/progress", progressHandler.ResetCard)
		r.Delete("/collections/{collectionID}/tests/{tqID}/progress", progressHandler.ResetTQ)
		r.Delete("/collections/{collectionID}/exercises/{exID}/progress", progressHandler.ResetExercise)
