...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/collections/{collectionID}/draft/diff": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/collections/{collectionID}/draft/items": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/collections/{collectionID}/draft/items/{itemID}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/collections/{collectionID}/draft/items/{itemID}/revert": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
